...
curl -sL -o /etc/vault.d/server.hcl https://raw.githubusercontent.com/dlavric/vault-dev-copy/main/server.hcl
#download systemd service
curl -sL -o /etc/systemd/system/vault.service https://raw.githubusercontent.com/kikitux/curl-bash/master/vault-dev-inmem/vault.service

systemctl enable vault.service
systemctl start vault.service 2>/dev/null

echo "vault-dev-inmem installed"
